      ...
      <form method="POST">
          ...
          <div>
              <nav class="navbar1 navbar-expand-lg">
                  <p class="text-center">Deposit Successful.</p>
              </nav>
          </div>
          <div class="blnc mt-4">
            <span class="ava">DEPOSITED AMOUNT :   </span>
            <span class="ava" style="color:lightgreen;"><?php echo $_SESSION['deposit_amount']?> +</span>
          </div>
          ...
          <div class="blnc mt-4">
            ...
            $query = mysqli_query($conn, "SELECT * FROM users_table WHERE user_id =  '$user_id'") or die(mysqli_error($conn));
            while($acc_blnc = mysqli_fetch_object($query)){ 
            ?>



            <span class="ava" style="color:#00bfff;"><?php echo $acc_blnc->account_blnc?> rs/-</span>
